...
class SecondFragment : Fragment(R.layout.second_fragment) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val tvSecondName: TextView = view.findViewById(R.id.tvSecondName)
        val tvEmail: TextView = view.findViewById(R.id.tvEmail)
        val btnClear: Button = view.findViewById(R.id.btnClear)

        tvFirstName.text =
            getString(string.formatted_first_name, arguments?.getString(FIRST_NAME_KEY))
        tvSecondName.text =
            getString(string.formatted_second_name, arguments?.getString(SECOND_NAME_KEY))
